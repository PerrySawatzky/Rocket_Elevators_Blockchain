...
export const QUALITY_ADDRESS = '0x4eA8518dAC9974AA72C4e86919c80A1685faF58A'

export const PROJECT_OFFICE_ABI = [
  {
    "inputs": [],
...
export const MATERIAL_PROVIDER_ABI = [
  {
    "inputs": [],
    "stateMutability": "nonpayable",
    "type": "constructor"
  ...
  },
  {
    "inputs": [
      ...
      {
        "internalType": "uint256",
        "name": "amountOfButtons",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "amountOfDisplays",
        "type": "uint256"
      }
    ],
      ...
      "outputs": [
        {
          ...
          "internalType": "struct QualitySecurity.Quality",
          "name": "",
          "type": "tuple"
        }
      ],
